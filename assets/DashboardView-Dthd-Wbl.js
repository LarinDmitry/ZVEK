...
`,P=U`
  ...
  box-shadow:
    ...
    0 1px 1px 0 rgba(0, 0, 0, 0.14),
    0 1px 3px 0 rgba(0, 0, 0, 0.12);
`,we=({title:a,titleId:t,...r},s)=>l.createElement("svg",{width:16,height:16,viewBox:"1 1 11 11",xmlns:"http://www.w3.org/2000/svg",ref:s,"aria-labelledby":t,...r},a?l.createElement("title",{id:t},a):null,l.createElement("path",{d:"M3.64645 11.3536C3.45118 11.1583 3.45118 10.8417 3.64645 10.6465L10.2929 4L6 4C5.72386 4 5.5 3.77614 5.5 3.5C5.5 3.22386 5.72386 3 6 3L11.5 3C11.6326 3 11.7598 3.05268 11.8536 3.14645C11.9473 3.24022 12 3.36739 12 3.5L12 9.00001C12 9.27615 11.7761 9.50001 11.5 9.50001C11.2239 9.50001 11 9.27615 11 9.00001V4.70711L4.35355 11.3536C4.15829 11.5488 3.84171 11.5488 3.64645 11.3536Z"})),_=l.forwardRef(we);G.register(K,V,X,F);const fe=()=>{const{language:a}=S(k),t=Q(),{NAME:r,TOTAL:s,DAMAGE:d,IMPACT:C,TOP_PLAYERS:m,OTHERS:E}=M(a),h=l.useMemo(()=>N.map(({name:g,info:x})=>({name:g,damage:x[x.length-1].damage,guildTotal:x[x.length-1].guildTotal})),[]),n=A(5)[2].guildTotal,o=A(5)[2].topDamagePercentage,c={labels:[m,E],datasets:[{data:[o*n,(100-o)*n],backgroundColor:["rgba(72, 99, 235, 0.7)","rgba(68, 217, 38, 0.7)"],hoverOffset:4}]},w=[r,d,C,""];return e.jsxs(je,{children:[e.jsxs(ye,{children:[e.jsx($e,{children:e.jsx(J,{data:c})}),e.jsxs(Re,{children:[s,": ",(A(5)[2].guildTotal/1e12).toFixed(2)," T"]}),e.jsx(Le,{onClick:()=>t("/main"),children:e.jsx(_,{})})]}),e.jsx(Ae,{children:e.jsxs(oe,{children:[e.jsx(H,{children:w.map(g=>e.jsx(O,{align:"center",children:e.jsx("b",{children:g})},g))}),e.jsx(le,{children:A(5)[2].topPlayers.map((g,x)=>{const p=h.find(T=>T.name===g)||{damage:0,guildTotal:1},$=[g,(p.damage/1e12).toFixed(2),`${(p.damage/p.guildTotal*100).toFixed(2)}%`,e.jsx(_,{})];return e.jsx(Se,{onClick:()=>t(`/details/${g}`),children:$.map((T,j)=>e.jsx(O,{align:"center",children:T},j))},x)})})]})})]})},je=i.div`
  display: grid;
  grid-gap: 1rem;
...
`,Pe=i.div`
  ...
  align-items: center;
  display: flex;
`,Ne=()=>e.jsxs(Oe,{children:[e.jsx(xe,{}),e.jsx(fe,{}),e.jsx(ke,{})]}),Oe=i.div`
  height: 100vh;
