...
import CustomizedSlider from './CalcilatorUtils';
import {bossHP} from './CalcilatorUtils';
...
const CalculatorView = () => {
  ...
  return (
    <Wrapper>
      <BackBtn />
      <Calculator>
        <Title>Калькулятор HP Боса</Title>
        ...
        <p>В боса лишилося {remainingHP.toLocaleString()} млрд HP</p>
      </Calculator>
    </Wrapper>
  );
};
